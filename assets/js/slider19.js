let root = document.querySelector(".slider19 .swiper .swiper-wrapper");

async function slider19() {
  try {
  ...
  //  swiper
     ...
     requestAnimationFrame(() => {
      if (window.swiper19) window.swiper19.destroy(true, true);
      window.swiper19 = new Swiper(".mySwiper19", {
        slidesPerView: 1,
        spaceBetween: 10,
        pagination: {
        ...
        breakpoints: {
          300: { slidesPerView: 1.15, spaceBetween: 10 },
